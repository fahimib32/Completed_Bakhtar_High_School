...
<!DOCTYPE html>
    <html lang="en-us">
        <head>
            ...
            <link rel="stylesheet" type="text/css" media="all" href="stylesheets/stylesheet_admin_home.css" />
            <script src="javascripts/dynamic-header-picture.js" type="text/javascript"></script>
            <script src="javascripts/teacherCardHideOrShourt.js" type="text/javascript" defer></script>
                                ...
                                <div id="add-teacher-section">
                                    <form action="add_teacher.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <fieldset>
                                            ...
                                            <span>
                                                <input type="text" name="addteachername" value="" id="teacher" required />
                                            ...
                                            <div class="figcaption-card">
                                                <div class="comment">
                                                    ...
                                                    <div class="comment-edit-option">
                                                        <button>
                                                            <a href="admin_student_feedback.php?id=<?php echo $student_feedback_table["id"]; ?>#feedback-wrap">Edit</a>
                                                        </button>
                                                        <button>
                                                            <a href="delete_feedback.php?feedback-id=<?php echo $student_feedback_table["id"]; ?>">Delete</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
